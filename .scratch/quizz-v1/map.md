...
- Operator role: who bans a Creator and handles abuse reports on a self-hosted instance (a configured admin email, a CLI?), shaped by the product-gaps answers.
